...
def start_anova(id, key, alpha, nrOfImportantFactors):
    ...
    sorted_significant_interactions = get_significant_interactions(retrieved['anova_result'], alpha, nrOfImportantFactors)
...
if __name__ == '__main__':
    ...
    id = "da5b66a4-c29b-9ceb-12c6-ef27599a4efc"
    key = "overhead"
